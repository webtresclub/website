...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-6" data-section="Hero">
      <div className="max-w-3xl w-full space-y-8 font-mono">
        <div className="space-y-6 border border-primary/30 p-8 bg-card/50">
          ...
          <div className="pt-4 flex justify-center">
            <a href="https://discord.gg/eegRCDmwbM" target="_blank" rel="noopener noreferrer" data-track-label="Join Discord CTA">
              <Button
                variant="outline"
